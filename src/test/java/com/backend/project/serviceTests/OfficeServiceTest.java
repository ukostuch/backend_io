...
public class OfficeServiceTest {
    ...
    public void addOffice_Success_OfficeAndDistrictAdded() throws FailedUploadingPhoto, InstantiationException, IllegalAccessException {
        DistrictDto districtDto = new DistrictDto(1, "Dzielnica A");
        OfficeDto officeDto = new OfficeDto(
                districtDto,
                "+48123456789",
    ...
    void getOfficeById_WhenOfficeExists_ReturnsOfficeDto() {
        District district = new District(1,"Dzielnica A");
        Office office = new Office(district,"+4810010010","Address1",UUID.randomUUID(),"Description");
        ...
        assertEquals("Dzielnica A", result.district().name());
        assertEquals("+4810010010", result.phoneNumber());
    ...
    public void getOfficesByDistrictNumber_Success_OfficesRetrievedByDistrict() {
        ...
        Office office1 = new Office(district1, "+48123456789", "Kwiatowa 12", UUID.randomUUID(), "Description 1");
        Office office2 = new Office(district1, "+48198765432", "Krupnicza 5", UUID.randomUUID(), "Description 2");
        Office office3 = new Office(district2, "+48111222333", "Weselna 22", UUID.randomUUID(), "Description 3");
        ...
        assertEquals("Kwiatowa 12", result.get().get(0).address(), "The first office's address should match.");
        assertEquals("Krupnicza 5", result.get().get(1).address(), "The second office's address should match.");
    }
    ...
    public void mapToDto_UsingReflection_OfficeMappedToDto() throws Exception {
        ...
        UUID photoId = UUID.randomUUID();
        District district = new District(1, "District A");
        Office office = new Office(district, "+48123456789", "Kwiatowa 12", photoId, "Short description");
        ...
        assertEquals("+48123456789", result.phoneNumber(), "The phone number should match.");
        assertEquals("Kwiatowa 12", result.address(), "The address should match.");
